...
@Component({
    selector: 'html-button-two',
    templateUrl: './html-button-two.component.html',
    styleUrls: ['./html-button-two.component.css']
})
export class HtmlButtonTwoComponent extends GaugeBaseComponent {

    static TypeTag = 'svg-ext-html_button_two';
    static LabelTag = 'HtmlButtonTwo';
    static prefixB = 'B-HXB2_';
                    ...
                    if (ga.property.actions) {
                        ga.property.actions.forEach(act => {
                            if (act.variableId === sig.id) {
                                HtmlButtonTwoComponent.processAction(act, element, button, val, gaugeStatus, propertyColor);
                            }
                        });
                    }
                }
